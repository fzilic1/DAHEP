...
plt.figure(1)
plt.hist(D_gg, bins=100, color='blue',density=True,label="ggH125", weights = w_gg, alpha=0.7, range=[0,1])
plt.hist(D_qq, bins=100, color='red',density=True,label="qqZZ", weights = w_qq, alpha=0.7, range=[0,1])
