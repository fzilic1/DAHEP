...
plt.hist(H0_data, bins=50, edgecolor='black', label='Španjolska')
plt.hist(H1_data, bins=50, edgecolor='black', label='Francuska')
plt.hist(H2_data, bins=50, edgecolor='black', label='Italija')
plt.hist(H3_data, bins=50, edgecolor='black', label='Nizozemska')
plt.legend(loc=1)
